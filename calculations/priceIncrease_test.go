...
func (uts *UnitTestSuite) TestCalculate_Success() {
	priceData := []*stocks.PriceData{
		{Price: 200.0, Timestamp: time.Now()},
		{Price: 100.0, Timestamp: time.Now().Add(-time.Minute)},
	}
...
func (uts *UnitTestSuite) TestCalculate_NoPriceData() {
...
func (uts *UnitTestSuite) TestCalculate_OnePriceData() {
	priceData := []*stocks.PriceData{
...
// func (uts *UnitTestSuite) TestCalculate_ZeroPrice() {
// 	priceData := []*stocks.PriceData{
// 		{Price: 0.0, Timestamp: time.Now()},
// 		{Price: 100.0, Timestamp: time.Now().Add(-time.Minute)},
// 	}
...
func TestNewPriceIncreaseCalculator(t *testing.T) {
	type args struct {
		pp stocks.PriceProvider
	}
	tests := []struct {
		name string
		args args
		want PriceIncreaseCalculator
	}{
		// TODO: Add test cases.
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := NewPriceIncreaseCalculator(tt.args.pp); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("NewPriceIncreaseCalculator() = %v, want %v", got, tt.want)
			}
		})
	}
}
